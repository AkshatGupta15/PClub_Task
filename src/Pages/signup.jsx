...
const Signup = () => {
  ...
  return (
    <div className='w-full border h-[100vh]'>
        ...
        {loading && <LoaderPage/>}
            <div className='w-1/4 mx-auto  flex flex-col gap-y-5 border rounded-xl py-10 px-10 shadow-xl'>
    ...
    <input type="text" className="grow" placeholder="Username" value={username} onChange={(e)=>{
